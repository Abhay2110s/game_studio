  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-md safe-bottom">
        ...
        >
          <div className="mx-auto w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-purple-600/20 border border-purple-500/30 flex items-center justify-center mb-3 sm:mb-4">
            <PauseCircle className="w-7 h-7 sm:w-8 sm:h-8 text-purple-400" />
          </div>
